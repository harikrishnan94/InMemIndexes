...
#
# 1. Set compiler flags to turn off optimization and enable coverage: SET(CMAKE_CXX_FLAGS "-g -O0
#   -fprofile-arcs -ftest-coverage") SET(CMAKE_C_FLAGS "-g -O0 -fprofile-arcs -ftest-coverage")
#
# 1. Use the function SETUP_TARGET_FOR_COVERAGE to create a custom make target which runs your test
...
#
# 1. Extract specific files/directories. Example: set(COVERAGE_EXTRACT
...
function(SETUP_TARGET_FOR_COVERAGE _targetname _testrunner _outputname)
    ...
    add_custom_target(
        ...
        COMMAND ${LCOV_PATH}
                --directory .
                --capture
                --output-file ${_outputname}.info.complete
        COMMAND ${LCOV_PATH}
                --extract ${_outputname}.info.complete ${COVERAGE_EXTRACT}
...
# Optional fourth parameter is passed as arguments to _testrunner Pass them in list form, e.g.:
# "-j;2" for -j 2
