...
public:
  ...
  uint64_t NextUnlocked() { return NextUnlocked(num_items_); }
...
inline uint64_t ZipfianGenerator::NextUnlocked(uint64_t num) {
...
inline uint64_t ZipfianGenerator::LastUnlocked() { return last_value_; }
